package com.example.bharath.service;


import com.example.bharath.Filter.CustomAuthority;
...
public class JwtService {
    ...
    public  String generateToken(String username, Collection<? extends GrantedAuthority> authorities,BankUsers bankUsers){
        Map<String,Object> claims = new HashMap<>();
        claims.put("firstname",bankUsers.getFirstname());
        claims.put("lastname",bankUsers.getLastname());
